# Note: the soultion for mix dotfiles and oh-my-zsh is that 
# split the environment variable ZSH and dotfiles variable
# and then use this standlone file for configing oh-my-zsh
